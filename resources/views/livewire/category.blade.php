                    ...
                    @foreach($categories as $category)
                        <tr>
                            ...
                            <td class="border px-4 py-2 w-40 text-center">
                                <button wire:click="edit({{ $category->id }})" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1.5 px-2.5 rounded">Edit</button>
                                <button data-modal-target="delete-modal" data-modal-toggle="delete-modal" wire:click="setDeleteId({{ $category->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1.5 px-2.5 rounded">Delete</button>
